...
$plugin_file = file_get_contents( dirname( __FILE__ ) . '/../plugin.php' );
...
if ( ! preg_match( '/define\( \'project_name_VERSION\', \'(?P<version>[^\\\']+)\'/', $plugin_file, $matches ) ) {
	echo "Could not find version in project_name_VERSION constant\n";
	exit( 1 );
}
$versions['project_name_VERSION'] = $matches['version'];
